...
const ConvoCard = () => {
	return (
		<div className='flex items-center gap-4 w-full h-fit p-5 bg-white bg-opacity-10 rounded-2xl hover:bg-opacity-30 duration-200 cursor-pointer'>
			<Badge
				size='sm'
				isOneChar
				color='success'
			...
			<div className='w-full'>
				<h2 className='text-lg font-[400] tracking-wide text-white'>Richard Wilson</h2>
 ...
 * 	<>
			<div className='receiver flex items-end gap-4 w-full h-fit p-3 rounded-2xl cursor-pointer'>
				...
				<div className='space-y-2'>
					<div className='flex flex-col gap-2'>
						<p className='text-md text-white max-w-[40%] bg-gray-500 p-3 rounded-2xl rounded-bl-none'>
			...
			<div className='receiver flex justify-end gap-4 w-full h-fit p-3 rounded-2xl cursor-pointer'>
				<div className='flex flex-col justify-end items-end gap-2'>
					<p className='text-md text-white max-w-[40%] bg-gray-500 p-3 rounded-2xl rounded-br-none'>
...
const MessageCard = () => {
	return (
		<>
			...
			<div className='h-full flex items-end justify-end gap-5 w-full bg-white'>
				<p className='text-md text-white max-w-[40%] bg-gray-500 p-3 rounded-2xl rounded-bl-none'>
...
const MessageContent = () => {
	return (
		<div className='flex flex-col w-[75%] bg-white bg-opacity-20 rounded-xl p-5'>
			...
			<div className='w-full'>
				<Input
					classNames={{
						inputWrapper:
							'w-full h-fit p-5 rounded-3xl bg-white bg-opacity-10 group-hover:bg-opacity-20 active:!bg-black',
					}}
					startContent={<i className='fa-solid fa-paperclip fa-lg text-white mr-3'></i>}
					endContent={<i className='fa-regular fa-paper-plane fa-lg text-white'></i>}
...
const RightSideBar = () => {
	...
	return (
		<aside className='flex flex-col gap-4 w-[25%] h-full text-white'>
			<div className='grid grid-cols-4 gap-2 rounded-2xl bg-white bg-opacity-10 p-4'>
				<div>
					<i className='fa-solid fa-phone-volume rotate-[320deg] bg-white bg-opacity-10 rounded-full p-4 text-xl hover:bg-yellow-600 cursor-pointer duration-200' />
				</div>
				<div>
					<i className='fa-solid fa-magnifying-glass bg-white bg-opacity-10 rounded-full p-4 text-xl hover:bg-yellow-600 cursor-pointer duration-200' />
				</div>
				<div>
					<i className='fa-solid fa-thumbtack rotate-[40deg] bg-white bg-opacity-10 rounded-full p-4 text-xl hover:bg-yellow-600 cursor-pointer duration-200' />
				</div>
				<div>
					<i className='fa-solid fa-user-group bg-white bg-opacity-10 rounded-full p-4 text-xl hover:bg-yellow-600 cursor-pointer duration-200' />
				</div>
			</div>

			<div className='rounded-2xl bg-white bg-opacity-10 p-4'>
			...
			<div className='rounded-2xl bg-white bg-opacity-10 p-4'>
				...
				<Accordion selectionMode='multiple'>
					<AccordionItem
						...
						title='115 photos'
						classNames={{
							title: 'text-white text-gray-400 text-md',
		...
		<div className='flex gap-5 bg-black h-screen w-screen p-7'>
			<div className='flex  items-end gap-3 h-full justify-start'>
				...
				<div className='flex flex-col gap-2 justify-end'>
					<p
						className='text-md text-white bg-gray-500 p-4 rounded-2xl rounded-bl-none
													'>
						I will add you to our team, welcome I will add you to our team, welcome I
						will add you to our team, welcome I will add you to our team, welcome I will
						add you to our team, welcome
